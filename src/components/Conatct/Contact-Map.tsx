export default function ContactMap() {
  return (
    <div className="bg-white shadow-md rounded-md p-4  border-l-4 border-b-4 border-[#B65C34] w-full max-w-[400px] mb-8 max-h-[350px] ">
      <h2 className="mb-5">Find Us</h2>
      <div className="w-full h-[200px] rounded-xl overflow-hidden shadow-lg mb-10">
        <iframe
          title="Google Map"
