export default function PriceList() {
  ...
  return (
    <div className="bg-[#f6f4d9] min-h-screen py-20 px-4 flex flex-col items-center font-serif">
      <div className="relative max-w-[640px] w-full">
        {/* Yellow Circles Behind the Card */}
        <div className="absolute -top-8 -left-8 w-20 h-20 bg-yellow-400 rounded-full z-0"></div>
        <div className="absolute -bottom-8 -right-8 w-20 h-20 bg-yellow-400 rounded-full z-0"></div>
